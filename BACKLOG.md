...
| [Phase2][cross-module] Threshold Calibration | ✅ РЕШЕНО (2026-08-17): active_threshold дефолт изменён с 0.0 на 1e-8 в CMCEnsemble, build_cmc_pipeline, SignalRegistry. Добавлен test_ensemble_default_threshold. Обновлены SPEC.md + PLAN.md для cmc. 159 тестов проходят. EMA never converges to exact 0.0 in float64 — 1e-8 предотвращает ложноположительные active_columns. | P1 | 2026-08-17 |
...
| [Phase2][sensory] Signal category taxonomy | ✅ РЕШЕНО (2026-08-17): SignalCategory enum + SignalSource frozen dataclass + SignalRegistry shell. models.py, registry.py, SPEC.md, PLAN.md, 20 тестов. Разведение extero-/intero-/communicative сигналов, reflex-path для severity ≥ 0.9. | P0 | 2026-08-17 |
